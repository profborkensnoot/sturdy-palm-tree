...
$MDMFolderReg ="HKLM:\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\"

$MDMItemReg ="HKLM:\SOFTWARE\Policies\Microsoft\Windows\CurrentVersion\MDM"

$MDMSchedule ="Schedule created by enrollment client for automatically enrolling in MDM from AAD"
...
#New-Item -Path $MDMFolderReg -Name MDM

#New-ItemProperty -Path $MDMItemReg -Name AutoEnrollMDM -Value 1

#New-ItemProperty -Path $MDMItemReg -Name UseAADCredentialType -Value 1

(Register-ScheduledTask -XML $TaskXML -TaskName $MDMSchedule -Force) | Out-null
